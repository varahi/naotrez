...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:tmpl/Resources/Private/Language/locallang_db.xlf:tx_tmplcemainslider_item',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => 'title,caption,image,link,link_title',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_tmplcemainslider_item.pid=###CURRENT_PID### AND tx_tmplcemainslider_item.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tmpl/Resources/Private/Language/locallang_db.xlf:tx_tmplcemainslider_item.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'image' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tmpl/Resources/Private/Language/locallang_db.xlf:tx_tmplcemainslider_item.image',
